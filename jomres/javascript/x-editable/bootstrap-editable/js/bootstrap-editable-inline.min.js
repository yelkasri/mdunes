...
(function (e) {
	...
	r.prototype = {constructor: r, show: function (t) {
		...
		while (h.valueOf() < d) {
			...
			if (h.getUTCFullYear() < n || h.getUTCFullYear() == n && h.getUTCMonth() < r)m += " old"; else if (h.getUTCFullYear() > n || h.getUTCFullYear() == n && h.getUTCMonth() > r)m += " new";
	...
	var i = e.fn.datepicker.dates = {en: {days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], daysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], daysMin: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"], months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], today: "Today"}}, s = {modes: [
		...
		if (a.length == s.parts.length) {
			...
			for (var c = 0, y; c < p.length; c++)y = p[c], y in h && d[y](n, h[y])
		}
		return n
