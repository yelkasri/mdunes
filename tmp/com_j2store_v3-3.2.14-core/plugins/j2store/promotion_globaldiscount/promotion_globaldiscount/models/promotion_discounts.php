...
class J2StoreModelPromotionDiscounts extends F0FModel
{
	...
	{
		$table_path =  JPATH_SITE. '/plugins/j2store/promotion_globaldiscount/promotion_globaldiscount/tables/';
	...
	public function buildQuery($overrideLimits = false)
	{
		...
		$query->from('#__j2store_promotions as tbl');
