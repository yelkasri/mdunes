...
class iDEAL_Payment
{
    ...
    ## Please activate when port 443 is open with your provider:
	## ue this only when you don't get a banklist or something similar.
	## The 443 post is saver to use.
	
	//protected $api_host        = 'http://secure.mollie.nl';
