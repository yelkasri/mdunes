...
<div class="row-fluid">
  <div class="span6">
    ...
    <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_TPL_SETTINGS' ); ?></h3>
    ...
    <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_SETTINGS' ); ?></h3>
    ...
    <table class="table table-striped">
     ...
     <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_ESETTINGS' ); ?></h3>
   ...
   <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_PSETTINGS' ); ?></h3>
    ...
    <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_EVENTPAGE_SETTINGS' ); ?></h3>
  ...
  <div class="span6">
	...
	<h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_CHECKOUT_SETTINGS' ); ?></h3>  
    ...
    <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_NEWSLETTER_SIGNUP_SETTINGS' ); ?></h3>
    ...
    <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_PDF_SETTINGS_NEW' ); ?></h3>
    ...
    <table width="99%" class="table table-striped">
      ...
      <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_COMPANY_SETTINGS' ); ?></h3>
