...
if (!file_exists(JPATH_COMPONENT.'/assets/images/header.jpg')) { ?>
 	    ...
 	    <?php  if ($this->config->send_multi_ticket_only == 1 or $this->config->send_multi_ticket_admin == 1){ ?>   
		    <div class="alert alert-error">
		      ...
		      <a target="_blank"  href="http://rd-media.org/support/knowledgebase/view-article/70-fpdf-error-missing-or-incorrect-image-file-header-jpg.html"><?php echo JText::_( 'COM_TICKETMASTER_READ_KNOWLEDGEBASE' ); ?></a>
		    </div>
    	<?php } ?>
...
if ($useractivation == 1) { ?>
    ...
    <div class="alert">
    	...
    	<a target="_blank"  href="http://nas.rd-media.org/rdmedia2014/index.php/support/faq/22-i-am-getting-warnings-in-the-control-panel"><?php echo JText::_( 'COM_TICKETMASTER_READ_KNOWLEDGEBASE' ); ?></a>
    </div>
