...
<table class="table table-striped" width="100%">
    ...
    <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_DESRIPTION' ); ?></h3>    
  ...
  <div class="span6">
    ...
    <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_CHOOSE_TICKET_LAYOUT' ); ?></h3>    
    ...
    <table class="table table-striped" width="100%">  
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="key" width="50%"><?php echo $this->lists['ticket_size']; ?>
                                    
            </td>
        </tr>  
        <tr>
            <td class="key" width="50%"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_ORIENTATION' ); ?></td>
            <td class="key" width="50%"><?php echo $this->lists['ticket_orientation']; ?>
    ...
    <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_LAYOUT' ); ?></h3>
    
    <table class="table table-striped" width="100%">  
        <tr>
            <td width="50%" valign="middle" class="key"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_NORMAL_TEXT' ); ?></td>
            <td width="50%" colspan="2" valign="middle"><input name="ticket_fontsize" type="text" value="<?php echo $this->data->ticket_fontsize; ?>" 
                            size="1" maxlength="3" placeholder="<?php echo JText::_( 'COM_TICKETMASTER_DEFAULT_9' ); ?>" />
            </td>
        </tr> 
        <tr>
            <td valign="middle" class="key"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_PRICE_TEXT' ); ?></td>
            <td colspan="2" valign="middle"><input name="ticketnr_fontsize" type="text" value="<?php echo $this->data->ticketnr_fontsize; ?>" 
                            size="1" maxlength="3" placeholder="<?php echo JText::_( 'COM_TICKETMASTER_DEFAULT_18' ); ?>"/>
            </td>
        </tr> 
        <tr>
            <td valign="middle" class="key"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_TICKETID_TEXT' ); ?></td>
            <td colspan="2" valign="middle"><input name="ticketid_nr_fontsize" type="text" value="<?php echo $this->data->ticketid_nr_fontsize; ?>" 
                            size="1" maxlength="3" placeholder="<?php echo JText::_( 'COM_TICKETMASTER_DEFAULT_9' ); ?>"/>
            </td>
        </tr> 
        <?php if ($this->config->pro_installed == 1){ ?>
            <tr>
                <td valign="middle" class="key"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_POSITION_TEXT' ); ?></td>
                <td colspan="2" valign="middle"><input name="font_size_seatnumber" type="text" value="<?php echo $this->data->font_size_seatnumber; ?>" 
                                size="1" maxlength="3" placeholder="<?php echo JText::_( 'COM_TICKETMASTER_DEFAULT_18' ); ?>"/> 
                </td>
            </tr> 
        <?php } ?>               
        <tr>
            <td valign="middle" class="key"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_NORMAL_COLOR' ); ?></td>
          <td colspan="2" valign="middle">
                <input name="ticket_fontcolor_r" type="text" value="<?php echo $this->data->ticket_fontcolor_r; ?>" 
                size="1" maxlength="3" class="input-mini" /> 
                <input name="ticket_fontcolor_g" type="text" value="<?php echo $this->data->ticket_fontcolor_g; ?>" 
                size="1" maxlength="3" class="input-mini"/>
                <input name="ticket_fontcolor_b" type="text" value="<?php echo $this->data->ticket_fontcolor_b; ?>" 
                size="1" maxlength="3" class="input-mini"/>
            </td>
        </tr>        
        <tr>
            <td valign="middle" class="key"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_PRICE_COLOR' ); ?></td>
          <td colspan="2" valign="middle">
                <input name="ticketnr_fontcolor_r" type="text" value="<?php echo $this->data->ticketnr_fontcolor_r; ?>" 
                size="1" maxlength="3" class="input-mini"/> 
                <input name="ticketnr_fontcolor_g" type="text" value="<?php echo $this->data->ticketnr_fontcolor_g; ?>" 
                size="1" maxlength="3" class="input-mini"/>
                <input name="ticketnr_fontcolor_b" type="text" value="<?php echo $this->data->ticketnr_fontcolor_b; ?>" 
                size="1" maxlength="3" class="input-mini"/>
            </td>
        </tr> 
        <tr>
            <td valign="middle" class="key"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_ID_COLOR' ); ?></td>
          <td colspan="2" valign="middle">
                <input name="ticketid_nr_fontcolor_r" type="text" value="<?php echo $this->data->ticketid_nr_fontcolor_r; ?>" 
                size="1" maxlength="3" class="input-mini"/> 
                <input name="ticketid_nr_fontcolor_g" type="text" value="<?php echo $this->data->ticketid_nr_fontcolor_g; ?>" 
                size="1" maxlength="3" class="input-mini"/>
                <input name="ticketid_nr_fontcolor_b" type="text" value="<?php echo $this->data->ticketid_nr_fontcolor_b; ?>" 
                size="1" maxlength="3" class="input-mini"/>
            </td>
        </tr> 
        <?php if ($this->config->pro_installed == 1){ ?>
            <tr>
                <td valign="middle" class="key"><?php echo JText::_( 'COM_TICKETMASTER_SEATNUMBER_COLOR' ); ?></td>
              <td colspan="2" valign="middle">
                    <input name="seatnumber_fontcolor_r" type="text" value="<?php echo $this->data->seatnumber_fontcolor_r; ?>" 
                    size="1" maxlength="3" class="input-mini"/> 
                    <input name="seatnumber_fontcolor_g" type="text" value="<?php echo $this->data->seatnumber_fontcolor_g; ?>" 
                    size="1" maxlength="3" class="input-mini"/>
                    <input name="seatnumber_fontcolor_b" type="text" value="<?php echo $this->data->seatnumber_fontcolor_b; ?>" 
                    size="1" maxlength="3" class="input-mini"/>
                </td>
            </tr> 
        <?php } ?>             
    ...
    <h3 style="color:#009; font-size:125%;"><?php echo JText::_( 'COM_TICKETMASTER_TICKET_LAYOUT_POSITIONS' ); ?></h3>
