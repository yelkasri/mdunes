    ...
    <div class="block">
        ...
        <div style="width:75%; margin-top:20px;">
            <table class="table">               
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="submit" value="<?php echo JText::_('COM_TICKETMASTER_LOGIN'); ?>" class="<?php echo $button; ?>"></td>
                </tr> 

                <tr>
                    <td>&nbsp;</td>
                    <td><a href="<?php echo $forgot_pass; ?>" onclick="window.open('<?php echo $forgot_pass; ?>','jevensternaam',
...
'width=800,height=400,scrollbars=no,toolbar=no,location=yes'); return false"><?php echo JText::_('COM_TICKETMASTER_FORGOT_USERNAME'); ?></a></td>
                </tr>                                                           
    ...
    <div class="block">
        ...
        <div style="width:75%; margin-top:20px;">
            <table class="table">               
                ...
                <tr>
                    <td><?php echo JText::_( 'COM_TICKETMASTER_YOUR_FIRSTNAME' ); ?>*</td>
                    <td><input name="firstname" type="text" id="firstname" class="inputbox" value="<?php echo $info[firstname]; ?>" size="25" /></td>
                </tr> 
                <tr>
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" value="<?php echo JText::_('COM_TICKETMASTER_REGISTER_NOW'); ?>" class="<?php echo $button; ?>"></td>
                </tr>
                <?php } ?>                  
            </table>
