...
class TicketmasterViewCheckout extends JViewLegacy {
	...
	function display($tpl = null) {
		...
		$lists['day'] = JHTML::_('select.genericlist', $days, 'day', 'class="inputbox"', 'value', 'text', $info['day']);
		...
		$lists['month'] = JHTML::_('select.genericList', $month, 'month', ' class="inputbox" ' , 'value', 'text', $info['month'] );
		...
		## Create <select name="year_from" class="inputbox"></select> ##
		$lists['year'] = JHTML::_('select.genericlist', $years, 'year', 'class="inputbox"', 'value', 'text', $info['year']);
