        ...
        <div style="width:75%; margin-top:20px;">
            <table class="table">               
                ...
                <tr>
                    ...
                    <td><input name="firstname" type="text" id="firstname" class="inputbox" value="<?php echo $this->data->firstname; ?>" size="25" /></td>
                </tr>
                <tr>
                    <td><?php echo JText::_( 'COM_TICKETMASTER_YOUR_LASTNAME' ); ?>*</td>
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" value="<?php echo JText::_('COM_TICKETMASTER_PLEASE_PROCESS_ORDER'); ?>" class="<?php echo $button; ?>"></td>
                </tr>
            </table>
