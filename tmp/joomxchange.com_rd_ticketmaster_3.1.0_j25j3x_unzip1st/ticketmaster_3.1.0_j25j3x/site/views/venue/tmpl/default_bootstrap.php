...
var position = new google.maps.LatLng(<?php echo $this->data->googlemaps_longitude; ?>, <?php echo $this->data->googlemaps_latitude; ?>);
var marker;
var map;	
	
  function initialize() {
	var mapOptions = {
	  center: new google.maps.LatLng(<?php echo $this->data->googlemaps_longitude; ?>, <?php echo $this->data->googlemaps_latitude; ?>),
	  zoom: 13,
